...
const hardcodedLine = computed(() => {
    ...
    if (props.card.is_real) {
        return 'Das ist tatsächlich so passiert.';
    }
                ...
                <div class="p-6">
                    ...
                    >
                        <div
                            v-if="revealed"
                            ref="revealEl"
                            class="mt-5 border-t border-black/[0.06] pt-5 dark:border-white/[0.08]"
                        >
                            <!-- User result -->
                            <span
                                :class="[
                                    'mb-3 inline-flex items-center gap-1 rounded-lg px-2.5 py-1 text-[13px] font-semibold',
                                    isCorrect
                            ...
                            <div
                                :class="[
                                    'mb-3 inline-flex items-center gap-1.5 rounded-full px-4 py-2 text-[15px] font-bold',
                                    card.is_real
                                        ? 'bg-[#34c759]/10 text-[#34c759]'
                                        : 'bg-[#ff3b30]/10 text-[#ff3b30]',
                                ]"
                            ...
                            >
                                ...
                                >
                                    <a
                                        ...
                                        target="_blank"
                                        rel="noopener"
                                        class="inline-flex items-center gap-1 text-[13px] text-[#007aff] hover:underline"
                                    >
                                        <ExternalLink
