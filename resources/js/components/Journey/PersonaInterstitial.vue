        ...
        <div class="flex-1 overflow-y-auto px-5 pb-4">
            ...
            >
                <div class="p-6">
                    ...
                    <h2
                        class="mb-3 text-[22px] leading-[1.25] font-bold tracking-[-0.4px] text-[#1d1d1f] dark:text-[#f5f5f7]"
                    >
                    ...
                    <div
                        v-if="previousCommentary"
                        class="mb-4 rounded-xl bg-[#f5f5f7] p-4 dark:bg-[#2c2c2e]"
                    >
                        <div class="mb-1.5 flex items-center gap-1.5">
                            <Sparkles
                                class="h-3.5 w-3.5 text-[#007aff] opacity-60"
                            />
                            <span
                                class="text-[11px] font-bold tracking-wider text-[#86868b] uppercase dark:text-[#98989d]"
                                >KI-Kommentar von gerade</span
                            >
                        </div>
                        <p
                            class="text-[14px] leading-[1.5] text-[#1d1d1f] italic dark:text-[#f5f5f7]"
                        >
                            {{ previousCommentary }}
                        </p>
                    </div>
                    ...
                    <p
                        class="mb-2 text-[15px] leading-[1.6] text-[#86868b] dark:text-[#98989d]"
                    >
                        Diese Antwort wurde von Claude (Anthropic) generiert.
                    ...
                    <p
                        class="mb-5 text-[14px] leading-[1.5] text-[#86868b] dark:text-[#98989d]"
                    >
                        Gib einen Stil ein und die KI kommentiert ab jetzt in
                        deinem Wunsch-Stil.
                    </p>
                    ...
                    <p
                        class="text-[12px] text-[#86868b]/50 dark:text-[#98989d]/50"
                    >
                        Der Stil gilt für alle weiteren KI-Kommentare in dieser
                        Session.
                    </p>
                </div>
            </div>
