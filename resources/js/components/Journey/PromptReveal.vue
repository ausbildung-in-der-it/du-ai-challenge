...
const highlightedPrompt = computed(() => {
    ...
    return text
        ...
        .replace(
            /GENAU/g,
            '<span class="font-bold text-[#ff9f0a]">GENAU</span>',
        );
});

const allDone = computed(
    () =>
        !props.commentaryLoading &&
        !promptTypewriter.isTyping.value &&
        props.commentaryText.length > 0,
);
</script>
            ...
            >
                <div class="p-6">
                    ...
                    >
                        ...
                        <p
                            class="font-mono text-[12px] leading-[1.6] whitespace-pre-wrap text-[#98989d]"
                    ...
                    <div
                        v-if="commentaryText || commentaryLoading"
